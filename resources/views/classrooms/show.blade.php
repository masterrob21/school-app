        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-4">
                <ul class="px-4 py-2 list-none bg-slate-200">
                    ...
                    <li class="inline text-lg before:p-2 before:content-['/'] capitalize">classroom Details</li>
                </ul>
            </div>
                ...
                <div class="p-6 text-gray-900">
                    <div class=" overflow-x-auto">
                        <table class="table-auto border-collapse border border-slate-400 w-full text-left">
                            ...
                            <tr class=" whitespace-nowrap">
                                <th class="p-3 border border-slate-300">class Teacher</th>
                                <td class="p-3 border border-slate-300 text-xl capitalize">{{ $classroom->last_name . ' ' . $classroom->first_name }}</td>
                            </tr>

                            <tr class=" whitespace-nowrap">
                                <th class="p-3 border border-slate-300">Capacity</th>
                                <td class="p-3 border border-slate-300 text-xl">{{ $classroom->capacity }}</td>
                            </tr>

                            <tr class=" whitespace-nowrap">
                                <th class="p-3 border border-slate-300">Date Created</th>
                                <td class="p-3 border border-slate-300 text-xl">{{ $classroom->created_at }}</td>
                            </tr>

                            <tr class=" whitespace-nowrap">
                                <th class="p-3 border border-slate-300">Date Updated</th>
                                <td class="p-3 border border-slate-300 text-xl">{{ $classroom->updated_at }}</td>
                            </tr>
                        </table>
                    </div>

                    <div class="mt-4">
                        <a href="/classrooms/{{$classroom->id}}/edit" class=" rounded bg-blue-300 py-2 px-3 text-lg">Edit</a>
                    </div>
                </div>
            </div>
        </div>
