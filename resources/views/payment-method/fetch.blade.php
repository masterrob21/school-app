        ...
        @foreach ($paymentMethods as $paymentMethod)
            <tr class="border-b even:bg-gray-50 whitespace-nowrap">
                <td class="px-3 py-1 flex items-center space-x-1">
                    <a href="paymentMethods/{{$paymentMethod->id}}/edit" class="p-2 bg-slate-400 hover:bg-slate-300 rounded">
                ...
                <td class="px-3 py-1 capitalize">{{ $paymentMethod->payment_mode }}</td>                                    
            </tr>
        @endforeach
    </tbody>
</table>
