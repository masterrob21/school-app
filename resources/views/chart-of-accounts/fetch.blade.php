    ...
    <tbody>
        @forelse ($accountcharts as $accountchart)
            <tr class="border-b even:bg-gray-50 whitespace-nowrap">
                ...
                <td class="p-2 capitalize">{{ $accountchart->account_head }}</td>
                <td class="p-2 capitalize">{{ $accountchart->account_type }}</td>
                <td class="p-2 capitalize">{{ $accountchart->sort_order }}</td>                                       
            </tr>
        @empty
            <tr class="border-b">
