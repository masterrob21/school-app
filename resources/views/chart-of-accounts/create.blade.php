        ...
        <div class=" max-w-7xl mx-auto px-8">
            <div class="mb-4">
                <ul class="px-4 py-2 list-none bg-slate-200">
                    ...
                    <li class="inline text-lg before:p-2 before:content-['/'] capitalize">New chart of account</li>
                </ul>
            </div>
        </div>
        ...
        <div class="w-full sm:max-w-lg mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('accountcharts.store') }}">
                        @csrf

                        <div >
                            <x-label for="account_head" value="{{ __('Account Head:') }}" />
                            <x-input id="account_head" class="block mt-1 w-full capitalize" type="text" name="account_head" :value="old('account_head')" required autofocus />
                        </div>

                        <div class="mt-4">
                            <x-label for="account_type_id" value="{{ __('Account Type:') }}" />
                            <x-select id="account_type_id" class="block mt-1 w-full capitalize" name="account_type_id">
                                <option value=""> ...</option>
