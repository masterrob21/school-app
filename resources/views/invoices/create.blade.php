            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('invoices.store') }}" method="POST" class="space-y-6">
                        ...
                        @php
                            $selectedStudent = $students->firstWhere('id', (int) old('student_id'));
                        ...
                        <div>
                            ...
                            <div id="invoice-items" class="mt-3 space-y-3">
                                @php
                                    $oldItems = old('invoice_items', [['name' => '', 'amount' => '', 'fee_type_id' => '']]);
                                @endphp
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <input type="number" step="0.01" min="0" name="sub_total" id="sub_total" value="{{ old('sub_total', 0) }}" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md bg-gray-100 focus:border-blue-500 focus:ring-blue-500" readonly>
                            </div>

                            <div>
                                <label for="discount_total" class="block text-sm font-medium text-gray-700">{{ __('Discount Total') }}</label>
                                <input type="number" step="0.01" min="0" name="discount_total" id="discount_total" value="{{ old('discount_total', 0) }}" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md bg-gray-100 focus:border-blue-500 focus:ring-blue-500" readonly>
                            ...
                            <div>
                                ...
                                <input type="number" step="0.01" min="0" id="grand_total" value="0.00" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md bg-gray-100 focus:border-blue-500 focus:ring-blue-500" readonly>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-end gap-4">
                            ...
                            <button type="submit" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 transition">{{ __('Create Invoice') }}</button>
                        </div>
                    </form>
                </div>
            </div>
