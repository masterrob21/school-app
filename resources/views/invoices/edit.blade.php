                    ...
                    <form action="{{ route('invoices.update', $invoice) }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <select name="academic_term_id" id="academic_term_id" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md focus:border-blue-500 focus:ring-blue-500" required>
                                    ...
                                    @foreach($academicTerms as $academicTerm)
                                        <option value="{{ $academicTerm->id }}" @selected((string) old('academic_term_id', $invoice->academic_term_id) === (string) $academicTerm->id)>{{ $academicTerm->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <input type="date" name="due_date" id="due_date" value="{{ old('due_date', $invoice->due_date) }}" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md focus:border-blue-500 focus:ring-blue-500" required>
                                @error('due_date')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
