            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between mb-3">
                        @can('add guardian') 
                        <div class="mt-2">
                            <a href="{{route('guardians.create')}}" class="p-3 capitalize rounded bg-green-300 hover:bg-green-500 whitespace-nowrap">Add guardian</a>
                        </div>
                        @endcan
                        <div class="">
