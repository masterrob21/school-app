        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-4">
                <ul class="px-4 py-2 list-none bg-slate-200">
                    ...
                    <li class="inline text-lg before:p-2 before:content-['/'] capitalize">Ledger accounts</li>
                </ul>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between mb-3">
                        @can('add ledger account')     
                        <div class="mt-2">
                            <a href="{{route('ledgeraccounts.create')}}" class="p-3 capitalize rounded bg-green-300 hover:bg-green-500 whitespace-nowrap">Add ledger account</a>
                        </div>
                        @endcan
                        <div class="">
    ...
    <script type="module">
        $(document).ready(function(){
            ...
            $('#search').keyup(function(){
                ...
                $.ajax({
                    url:"{{route('ledgeraccounts.fetch')}}",
                    method:'get',
                    data:{id: search},
