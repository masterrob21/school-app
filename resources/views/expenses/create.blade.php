        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-4">
                <ul class="px-4 py-2 list-none bg-slate-200">
                    ...
                    <li class="inline text-lg capitalize before:p-2 before:content-['/']">Expense</li>
                </ul>
            </div>
                    ...
                    <form method="POST" action="{{ route('expenses.store') }}">
                        ...
                        <div class="grid gap-6 grid-cols-1 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <div class="mt-4">
                                    <x-label for="ledger_account_id1" value="{{ __('Cash Account') }}" />
                                    <x-select name="ledger_account_id1" id="ledger_account_id1" class="block mt-1 w-full capitalize" :value="old('ledger_account_id1')" required>
                                        ...
                                        @foreach ($cashAccounts as $cashAccount)
                                            <option value="{{ $cashAccount->id }}">{{ $cashAccount->ledger_name }}</option>
                                        @endforeach
                                    </x-select>
                                </div>
