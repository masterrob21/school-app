<table class="table-auto w-full text-left">
    ...
    <tbody>
        @if (count($currencies)<1)
            <tr class="border-b">
                <td colspan="3" class="p-3 text-xl font-bold text-red-400"><h2>No record found.</h2></td>
            </tr>
        @endif
            ...
            <tr class="border-b even:bg-gray-50 whitespace-nowrap capitalize">
                <td class="p-2 flex items-center space-x-1">
                    ...
                    <form action="" method="POST" id="delete_form">
                        @csrf
                        @method('DELETE')
                        <button id="{{$currency->id}}"  class="btn_remove p-2 bg-red-400 hover:bg-red-300 rounded">
