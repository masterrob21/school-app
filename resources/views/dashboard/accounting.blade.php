                ...
                <div class="p-6 text-gray-900">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 justify-items-stretch ">
                       ...
                       <div class="flex p-4 border border-solid rounded-md bg-gray-100">
                            ...
                            <div class="ml-2">
                                <h2"><a href="{{ route('expenses.create') }}" class="text-blue-600 text-2xl font-bold hover:underline">Expense</a></h2>
                                <p>Add</p>
                            </div>
                        </div>
                        ...
                        <div class="flex p-4 border border-solid rounded-md bg-gray-100">
                            ...
                            <div class="ml-2">
                                <h2"><a href="{{ route('invoices.index') }}" class="text-blue-600 text-2xl font-bold hover:underline">Invoices</a></h2>
                                <p>view, add & update</p>
                            </div>
                        </div>
