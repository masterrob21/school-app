                ...
                <div class="p-6 text-gray-900">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 justify-items-stretch ">
                       <div class="flex p-4 hover:border-t-4 border-solid hover:border-indigo-500">
                            ...
                            <div class="ml-2">
                                <h2"><a href="/roles" class="text-blue-600 text-2xl font-bold hover:underline">Role</a></h2>
                       ...
                       <div class="flex p-4 hover:border-t-4 border-solid hover:border-indigo-500">
                            ...
                            <div class="ml-2">
                                <h2"><a href="/user" class="text-blue-600 text-2xl font-bold hover:underline">User</a></h2>
                                <p>Add, update & delete.</p>
                            </div>
                        </div>
