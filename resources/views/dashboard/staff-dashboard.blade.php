                ...
                <div class="p-6 text-gray-900">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 justify-items-stretch ">
                       {{-- <div class="flex p-4 hover:border-t-4 border-solid hover:border-indigo-500">
                            ...
                            <div class="ml-2">
                                <h2"><a href="/students" class="text-blue-600 text-2xl font-bold hover:underline">Student</a></h2>
                                <p>Add & update.</p>
                            </div>
                       </div> --}}
                       ...
                       {{-- <div class="flex p-4 hover:border-t-4 border-solid hover:border-indigo-500">
                            ...
                            <div class="ml-2">
                                <h2"><a href="/guardians" class="text-blue-600 text-2xl font-bold hover:underline">Guardian</a></h2>
                        ...
                        <div class="flex p-4 border border-solid rounded-md bg-gray-100">
                            ...
                            <div class="ml-2">
                                <h2"><a href="/staffs" class="text-blue-600 text-2xl font-bold hover:underline">Staff</a></h2>
                                <p>Add, update & delete.</p>
                            </div>
                       </div>
