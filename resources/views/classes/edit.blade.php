<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('Edit School Class') }}</h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-4">
                <ul class="px-4 py-2 list-none bg-slate-200">
                    ...
                    <li class="inline text-lg before:p-2 before:content-['/']">{{ __('Edit') }}</li>
                </ul>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('classes.update', $schoolClass) }}" method="POST" class="space-y-6">
                        @csrf
                        @method('PATCH')
