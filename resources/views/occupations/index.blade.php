        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-4">
                <ul class="px-4 py-2 list-none bg-slate-200">
                    ...
                    <li class="inline text-lg before:p-2 before:content-['/']">List of Occupations</li>
                </ul>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between mb-3">
                        ...
                        <div class="">
                            <input id="search" type="text" class="rounded sm:w-96 w-full" placeholder="Search occupation">
                        </div>
                    </div>
                    <div class="overflow-x-auto" id="search_results">
                        @include('occupations.fetch')
                    </div>
