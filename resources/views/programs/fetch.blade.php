        ...
        @foreach ($programs as $program)
            <tr class="border-b even:bg-gray-50 whitespace-nowrap capitalize">
                <td class="p-2 flex items-center space-x-1">
                    <a href="programs/{{$program->id}}" class="p-2 bg-slate-400 hover:bg-slate-300 rounded">
                ...
                <td class="p-2 uppercase">{{ $program->program_type }}</td>                                    
                <td class="p-2 capitalize">{{ $program->program }}</td>                                    
                <td class="p-2">{{ $program->sort_order }}</td>                                    
            </tr>
        @endforeach
    </tbody>
</table>
