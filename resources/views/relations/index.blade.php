            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between mb-3">
                        <div class="mt-2">
                            <a href="{{route('relations.create')}}" class="p-3 capitalize rounded bg-green-300 hover:bg-green-500 whitespace-nowrap">New relation</a>
                        </div>
                        <div class="">
                            <input id="search" type="text" class="rounded sm:w-96 w-full capitalize" placeholder="Search relation">
                        </div>
                    </div>
                    <div class="overflow-x-auto" id="search_results">
                        @include('relations.fetch')
                    </div>
