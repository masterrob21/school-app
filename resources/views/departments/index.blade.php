            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between mb-3">
                        ...
                        <div class="">
                            <input type="text" class="rounded sm:w-96 w-full" placeholder="Search department">
                        </div>
                    </div>
                        ...
                        <table class="table-auto w-full text-left">
                            ...
                            <thead class="bg-blue-200">
                                <tr class="border-b  whitespace-nowrap">
                                    ...
                                    <th class="p-3">Department Head</th>
                            </thead>
                                ...
                                @foreach ($departments as $department)
                                    <tr class="border-b even:bg-gray-50 whitespace-nowrap">
                                        <td class="p-2 flex items-center space-x-1">
                                            <a href="departments/{{$department->id}}" class="p-2 bg-slate-400 hover:bg-slate-300 rounded">
                                            ...
                                            <form action="" method="POST" id="delete_form">
                                                @csrf
                                                @method('DELETE')
                                                <button id="{{$department->id}}"  class="btn_remove p-2 bg-red-400 hover:bg-red-300 rounded">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 inline-block">
                                        ...
                                        <td class="p-2 capitalize">{{ $department->department_name }}</td>
                                        <td class="p-2 capitalize">{{ $department->last_name . ' ' . $department->first_name }}</td>                                       
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
