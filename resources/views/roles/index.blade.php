        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-4">
                <ul class="px-4 py-2 list-none bg-slate-200">
                    <li class=" inline text-lg"><a href="/security" class="text-blue-600 hover:underline capitalize">security</a></li>
                    <li class="inline text-lg before:p-2 before:content-['/']">List of Roles</li>
                </ul>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mt-2">
                        <a href="{{route('roles.create')}}" class="p-3 capitalize rounded bg-green-300 hover:bg-green-500 whitespace-nowrap">Add role</a>
                    </div>
                                ...
                                @foreach ($roles as $role)
                                    <tr class="border-b even:bg-gray-50 whitespace-nowrap capitalize">
                                        <td class="p-2 flex items-center space-x-1">
                                            ...
                                            @endunless  
                                            class="p-2 bg-slate-400 hover:bg-slate-300 rounded">
                                            ...
                                            <form action="" method="POST" id="delete_form">
                                                @csrf
                                                @method('DELETE')
                                                <button id="{{$role->id}}"  class="btn_remove p-2 bg-red-400 hover:bg-red-300 rounded">
                                            ...
                                            <a href="/role-permissions/{{$role->id}}/edit" class="p-2 bg-green-400 hover:bg-green-200 rounded text-sm">Add/Edit Role Permission</a>
                                        </td>
